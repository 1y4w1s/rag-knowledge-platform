...
export function useThreadSession(context: ThreadContext) {
  ...
  return {
    ...
    submittingProposal: ms.submittingProposal,
    proposalError: ms.proposalError,
    clarifying: ms.clarifying,
    clarifyError: ms.clarifyError,
    clarifyProposal: ms.clarifyProposal,
    ...
    submitProposal: ms.submitProposal,
    cancelProposal: ms.cancelProposal,
