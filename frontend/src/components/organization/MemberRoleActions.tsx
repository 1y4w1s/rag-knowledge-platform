...
export function MemberRoleActions({
  ...
  if (member.role === "member") {
    return (
      <Button
        ...
        size="sm"
        disabled={changing}
        className="h-8 px-2 text-[0.8125rem] text-[#8B5A42] hover:bg-[#EFEBE6] hover:text-[#6E4A38]"
  ...
  return (
    <Button
      ...
      size="sm"
      disabled={changing}
      className="h-8 px-2 text-[0.8125rem] text-muted hover:bg-[#EFEBE6] hover:text-foreground"
