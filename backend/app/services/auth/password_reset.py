"""Forgot password / reset password service using Resend."""
...
RESET_TOKEN_KEY_PREFIX = "reset_pw:"
...
async def send_password_reset_email(
    ...
    *,
    ...
    """Find user by email/username, generate token, send email via Resend."""
    ...
    try:
        ...
        resend.Emails.send(
            {
                "from": settings.forgot_password_from_email,
                "to": [user.email],
                "subject": "重置您的睿阁密码",
                "html": f"""
                <p>您好，</p>
...
async def reset_password(
    ...
    *,
    ...
    from app.services.auth.service import MIN_PASSWORD_LEN
