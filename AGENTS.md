...
| **企业化下一波** | ✅ 阶段 A/B/C/D/E · **EW-D1～D6 ✅** · **R1 ✅** · **R2 ✅** · **R3-1 ✅** · **R3-2 ✅** · **R3-3 Research ✅（不 Implement）** · **R3-4 ✅** · **R4-1 ✅** · **R4-2 ✅** · **R4-3 ✅** · **R4-4 ✅** · **R5-1 ✅** · **R5-2 ✅** · **R5-3 ✅** · **R5-4 ✅** · **Plan-3E-6 ✅** · **B2 ✅** |
...
- **大表 / 跨页表格（B2 ✅ 2026-07-21）**：PDF 相邻同表保守合并 + 超长 MD 表行窗（每窗带表头）；短 parent 有上限；TABLE_CHUNK_SPLIT_ENABLED 默认开。不改检索默认。详见 TECH-4.2.3 · 	est_table_chunk_b2.py。
